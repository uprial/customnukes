...
class TaskEScenarioActionRepeaterAction extends BukkitRunnable  {
    private final EScenarioActionRepeater executor;
    private final CustomNukes plugin;
    private final Location location;
    private int runsCount;

    TaskEScenarioActionRepeaterAction(EScenarioActionRepeater executor, CustomNukes plugin, Location location, int runsCount) {
